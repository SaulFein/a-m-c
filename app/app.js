  ...
  .directive("routeLoadingIndicator", [
    ...
    function ($rootScope) {
      return {
        restrict: "E",
        template:
          "<div class='col-lg-12' ng-if='isRouteLoading'><h1>Loading <i class='fa fa-cog fa-spin'></i></h1></div>",
    ...
    return {
      link: function (scope, element) {
        ...
        var getFileTileUrl = function (fileUrl) {
          var str = fileUrl;
          var res = str.replace(
            "https://cdn.filepicker.io/api/file/",
            "https://process.filestackapi.com/resize=width:700/"
          );
          return res;
        };
    ...
    return {
      link: function (scope, element) {
        ...
        var getFileTileUrl = function (fileUrl) {
          ...
          var res = str.replace(
            "https://cdn.filepicker.io/api/file/",
            "https://process.filestackapi.com/resize=width:300/"
          );
          return res;
        };
